...
Ext.Osiris.RegisterListener("LeveledUp", 1, "after", function(character)
    Ext.Timer.WaitFor(1000, function ()
        ...
        if adjustPoints('Spellbinder_SpellDancer_EtherealPresence', character, characterEntity, "77a9fd60-e7fe-40a7-84c2-8e2aeff5a8ff", "Charisma") then changed = true end
        if changed then
